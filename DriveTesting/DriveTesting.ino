...
Motor motorL {MOTOR_L_PWM, MOTOR_L_DIR, 0, 0};
Motor motorR {MOTOR_R_PWM, MOTOR_R_DIR, 0, 0};
...
void runMotor(Motor& m, Direction dir, byte spd)
{
  ...
  digitalWrite(m.dir_pin,(dir != REV) ? FWD_STATE : !FWD_STATE);
}
